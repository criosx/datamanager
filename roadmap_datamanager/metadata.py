...
from roadmap_datamanager.datalad_utils import ensure_paths, get_dataset_version
...
class Metadata:
    ...
    def add(self,
        ...
        if self.relposix != '.':
            node_id = f"datalad:{dataset_type}{dataset_id}:{self.relposix}"
            toplevel_type = 'file'
        else:
            node_id = f"datalad:{dataset_type}{dataset_id}"
